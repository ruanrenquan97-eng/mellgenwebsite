...
TRANSLATIONS = [
    ...
    ("拥有生物透皮技术孵化平台，开展分子生物学、细胞生物学、发酵与纯化工程、制剂开发及人体功效验证等研发工作。1000平GMP细胞工厂，装载7台发酵罐， 总装量达5吨；2000平制剂生产平台，含冻干粉剂生产线，乳化生产线。公司具备从上游分子设计、工艺开发和功效验证到下游原料生产以及终端产品生产贯通的上下游产业链。",
     "Featuring a biological transdermal incubation platform for molecular biology, cell biology, fermentation & purification, formulation development, and clinical efficacy testing. A 1,000m² GMP cell factory with 7 fermenters totaling 5 tons; a 2,000m² formulation platform with freeze-dried powder and emulsification lines."),
