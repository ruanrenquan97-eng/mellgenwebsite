# -*- coding: utf-8 -*-
"""
Mellgen Biotechnology Full Website English Generator & Language Switcher
"""
...
DICT_ITEMS = [
    ...
    ("公司专注“皮肤内源分子”\"海洋仿生分子”和“特色植物资源”的研究。 以人工智能分子设计，合成生物学基础，基因工程、发酵工程为技术手段，开发新一代透皮增强型生物活性分子， 实现蛋白质多肽，植物多糖以及微生物发酵产物等特色功效性生物资源的绿色开发与产业化。",
     "The company focuses on 'skin endogenous molecules', 'marine biomimetic molecules', and 'featured botanical resources', applying AI molecular design, synthetic biology, genetic engineering, and fermentation to develop next-generation transdermal-enhanced bioactive molecules."),
    ...
    ("集合分子设计、工艺开发和功效验证到下游原料生产以及终端产品一站式",
     "One-stop integration from molecular design, process development, and efficacy validation to downstream raw material and end-product manufacturing"),

    ("为各大化妆品加工厂，医用，食品品牌等提供应用解决方案",
     "Providing application solutions for cosmetic manufacturers, medical and food brands worldwide"),

    ("产品成功打入美国、欧洲、 东南亚等重点区域，备受赞誉",
     "Products successfully exported to the US, Europe, Southeast Asia, and other key regions, earning high acclaim"),

    ("成功打入美国、欧洲、 东南亚等重点区域，备受赞誉",
     "Successfully exported to the US, Europe, Southeast Asia, and other key regions, widely acclaimed"),

    ("每日价值资讯，精彩资讯实时推荐",
     "Daily valuable insights and real-time industry updates"),

    ("国内外1000+家品牌方携手2000+款化妆品品牌选用我们的原料",
    ...
    ("美尔健生物从源头做好产品",
     "Mellgen Biotech: Crafting Superior Products from the Source"),

    # News / Articles Titles & Subtitles
    ("爆品密码再升级:成分x剂型x场景=透皮5D胶原系列，一招破解胶原流失焦虑!",
     "Blockbuster Code: Ingredient × Form × Scenario = Transdermal 5D Collagen Series, Solving Collagen Depletion!"),
    ("爆品密码再升级:成分x剂型x场景=透皮5D胶原系列，一招破解胶原流失焦虑",
     "Blockbuster Code: Ingredient × Form × Scenario = Transdermal 5D Collagen Series"),
    ("颠覆性透皮科技!美尔健发明专利矩阵，打造“超车式竞争力”",
     "Disruptive Transdermal Tech! Mellgen Patent Matrix Builds Leapfrog Competitiveness"),
    ("敏感肌护肤新趋势：天然+科技，开启修护抗衰新纪元",
     "Sensitive Skin New Trend: Natural + Tech, Ushering in Repair & Anti-Aging Era"),
    ("捷报！美尔健生物霸榜「了不起的中国原料」，实力藏不住了",
     "Triumph! Mellgen Tops 'Great Chinese Raw Materials' List!"),
    ("2026年皮肤科SCI期刊影响因子重磅发布：格局重塑下的投稿策略与选题风向",
     "2026 Dermatology SCI Impact Factors Released: Editorial Trends & Direction"),
    ("胶原蛋白信任危机？美尔健揭秘「真技术」，拒绝概念添加！",
     "Collagen Trust Crisis? Mellgen Reveals Genuine Technology, Rejecting Mere Concept Addition!"),
    ("30+抗老新思路：不是补胶原，是给肌肤重铺“弹簧床”",
     "30+ Anti-Aging: Rebuilding the Skin's 'Spring Mattress' Support"),
    ("别再给敏感肌乱“进补”了！细胞级修护才是真·换脸秘籍",
     "Cellular-Level Repair: The Genuine Strategy for Sensitive Skin Rejuvenation"),
    ("🔑 一把“钥匙”，5分钟打开皮肤通道——大分子透皮不再是难题",
     "🔑 The Key to Opening Skin Channels in 5 Mins — Transdermal Biomacromolecules Solved"),
    ("三文鱼DNA多维修护！探索深层水润与肌肤屏障焕活新机制",
     "Salmon DNA Multi-Dimensional Repair: Deep Hydration & Barrier Revitalization"),
    ("决赛晋级！透皮环肽cTDP斩获「了不起的中国原料」总决赛入场券！",
     "Finals Qualified! Transdermal Cyclic Peptide cTDP Enters 'Great Chinese Raw Materials' Finals!"),
    ("双认证加持！美尔健生物斩获ISO 9001与FDA GMP认证，开启原料国际化新征程",
     "Dual Certifications! Mellgen Obtains ISO 9001 & FDA GMP, Launching Global Strategy"),
    ("美尔健生物5D透皮胶原蛋白获中国发明专利授权，开启活性成分高效渗透新时代！",
     "Mellgen 5D Transdermal Collagen Awarded Invention Patent, Leading High Penetration Era!"),
    ("美尔健生物2025PCHi完美收官/带你回顾精彩盛况",
     "Mellgen Biotech 2025 PCHi Recap: Highlights & Innovation Showcases"),
    ("突破透皮困局！中国团队发现PDRN抗老新靶点，美尔健生物环肽技术破解吸收难题",
     "Overcoming Transdermal Limits! PDRN Target Discovered, Cyclic Peptide Solves Absorption Barrier"),
    ("2025敏感肌护肤新趋势：天然+科技，开启修护抗衰新纪元",
     "2025 Sensitive Skin Trends: Natural + Science, Opening New Repair & Anti-Aging Era"),
    ("PDRN是什么？揭秘美尔健生物的合成生物学如何引领皮肤再生科技新纪元",
     "What is PDRN? How Synthetic Biology Leads Skin Regeneration Tech"),
    ("温和舒缓干痒不适！揭秘「益生舒缓因子」如何赋能敏肌修护",
     "Gentle Soothing for Dry Itchiness: Probiotic Soothing Factor in Sensitive Skin Repair"),
    ("胶原蛋白信任危机背后，美尔健生物如何用「真技术」破解行业信任危机？",
     "Behind Collagen Trust Crisis: How Mellgen Restores Trust with True Bio-Tech"),
    ("肌肤的 “吸收密码”，你找到了吗？",
     "Have You Unlocked Your Skin's 'Absorption Code'?"),
    ("科普视频｜3分钟看懂原料中蛋白的含量",
     "Science Video | 3-Minute Guide to Protein Purity & Content"),
    ("美尔健生物：为医用领域提供创新生物活性材料解决方案",
     "Mellgen Biotech: Delivering Innovative Bioactive Material Solutions for Medical Field"),
    ("未来美妆战场，创新定制原料成为品牌核心竞争力！",
     "Future Beauty Battlefield: Custom Innovative Raw Materials as Core Competitiveness!"),
    ("皮肤护理做不好？这里有高科技方案",
     "Suboptimal Skincare Results? High-Tech Bio Solutions Here"),
    ("你还在用没效果的护肤品？看这里",
     "Still Using Ineffective Skincare? Discover Transdermal Science"),
    ("美尔健生物给您拜年啦",
     "Mellgen Biotech Season's Greetings"),
    ("2025护肤品市场千亿预热！！！",
     "2025 Skincare Market: 100-Billion Surge!"),
    ("“中国芯”原料定制，成美妆爆款新密码！",
     "'China-Core' Material Customization: Secret to Beauty Best-sellers!"),
    ...
    ("颠覆性的第三代透皮肽融合技术", "Disruptive 3rd-Gen Transdermal Peptide Fusion Tech"),
...
def get_lang_switch_html(is_en=False, depth=0):
    if is_en:
        # On English page: CN links back to Chinese root/page, EN stays active
        if depth == 0:
            cn_url = "../index.html"
            en_url = "./index.html"
        else:
  ...
  <a href="{en_url}" class="active" title="English">EN</a>
        ...
        # On Chinese page: CN active, EN links to English root/page
        if depth == 0:
            cn_url = "./index.html"
...
def translate_content(text):
    for cn, en in DICT_ITEMS_SORTED:
        text = text.replace(cn, en)
    
    text = re.sub(r'<html[^>]*lang=["\']zh[^"\']*["\']', '<html lang="en"', text, flags=re.I)
    return text
...
def process_file(src_rel_path):
    ...
    en_html = translate_content(src_html)
    depth_en = depth_cn
...
def main():
    ...
    print(f"Total HTML files to process: {len(all_htmls)}")
    for h in all_htmls:
        process_file(h)
