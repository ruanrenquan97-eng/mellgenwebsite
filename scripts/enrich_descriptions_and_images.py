...
diagram_map = {
    ...
    "tpxldb": {
        ...
        "caption_zh": "透皮重组纤连蛋白TFNpro毛细渗透吸收提升8倍与角质层屏障修护组织病理切片",
...
rich_content_zh = {
    ...
    "tpxldb": (
        "<p>透皮纤连蛋白(TFNpro)是融合中国科学技术大学生物透皮技术的重组功能性大分子糖蛋白，采用现代合成生物学与高密度酵母发酵工程制备，纯度超过95%，具有卓越的高活性与高稳定性。</p>"
        "<p>分子中高度保留天然重组纤连蛋白的关键RGD细胞识别粘附功能区，搭载透皮环肽后透皮吸收效率提升10倍。能特异性引导角质形成细胞向微损伤区域有序迁移，加速角质层物理屏障强韧构建，维持肌肤水油平衡与锁水厚度，显著改善干燥敏感、换季脱屑及屏障脆弱不适。</p>"
    ),
    "tp1jydb": (
        "<p>透皮I型胶原蛋白采用先进制药级合成生物技术制备，为100%仿生重组氨基酸序列的全长活性I型胶原分子，并创新融入美尔健第三代生物透皮肽技术，彻底突破传统I型大分子胶原只停留在表皮成膜的局限。</p>"
    ...
    "tptxdb": (
        "<p>透皮弹性蛋白Telastin为100%重组功能弹性蛋白，运用先进酵母生物工程表达与梯度纯化工艺制备，具有与人体自身弹性蛋白高度同源的一级序列与亲水柔韧特性。</p>"
    ...
    "gtlafdp": (
        "<p>寡肽类MEGPEP AFDP是依托国家发明专利技术制备的高活性重组多肽冻干粉，由高纯度寡肽-2与高纯级保护基质复配精制而成，具备分子量小、组织相容性好及靶向抗氧化能力强的显著优势。</p>"
    ...
    "lrdt": (
        ...
        "<p>该成分性质温和稳定，能保护表皮与真皮细胞免受外界氧化因子的损伤，维持细胞正常生理代谢更新节奏。显著改善因年龄与疲劳导致的肌肤粗糙暗哑、松弛干瘪，提升肌肤内在防御力与自我修护潜能，是高端奢华抗衰、贵妇紧致面霜与院线抗皱安瓶的甄选原料。</p>"
    ),
    "smndb": (
        "<p>JELFIPRO水母黏蛋白是利用独创低温生物酶法从天然海洋水母中分离提取的高纯度活性糖蛋白与黏多糖复合物，彻底规避了陆生哺乳动物源病毒隐患，荣获广东省金穗奖专利二等奖。</p>"
        "<p>保留了最纯正的天然三螺旋生物活性空间构象，具有远优于常规鱼胶原和猪胶原的生物亲和力。能有效抑制紫外线辐射诱导的光老化损伤与胶原基质降解，显著减少经表皮水分流失(TEWL)，舒缓泛红干敏，促进表皮组织充盈紧致，适用于抗光老化精华、敏感肌修护及温和屏障护理防护配方。</p>"
    ),
    "0xjydb": (
    ...
    "aminofree": (
        ...
        "<p>产品严格依据健康皮肤角质层天然保湿因子(NMF)的黄金比例进行分子配比，小分子无阻碍经皮渗透。能够直接参与表皮角质细胞的蛋白质修护代谢与细胞间质构建，改善肌肤干燥紧绷，增强角质层厚度与弹润触感，是高端抗衰底液与修护打底配方的核心基石。</p>"
    ),
    "colamino": (
    ...
    "tpxviijy": (
        "<p>透皮XVII型胶原蛋白是美尔健应用前沿基因重组工程构建的重组XVII型跨膜胶原蛋白，搭载自主专利透皮环肽递送载体，专攻表皮-真皮交界区(DEJ)基底膜及毛囊干细胞微环境的深层抗衰。</p>"
    ...
    "mgpdrn": (
        ...
        "<p>在透皮环肽的高效促透驱动下，DNA钠穿透表层屏障为受损干燥细胞补充核苷酸修护养元；高品质玫瑰精粹多酚与芳香分子协同改善面部微循环，平抚泛红粗糙，提升紧致弹润。长期使用使干瘪暗哑肌肤焕发出如晨露玫瑰般娇嫩饱满、白里透粉的健康光采。</p>"
    ),
    "4dzyshyz": (
